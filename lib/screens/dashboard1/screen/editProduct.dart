...
import 'createDiscountOffer.dart';

class EditProduct extends StatefulWidget {
  Product prod;

  EditProduct({this.prod});
...
/*  void changeColor(Color color) => setState(() => currentColor = color);*/
  ...
  _handleEditProduct(String productId) async {
    ...
    if ((_apiResponse.ApiError as ApiError) == null) {
      showInSnackBar(AppLocalizations.of(context).productSuccessfullyUpdated);
      setState(() {
        isLoading = false;
      });
    } else {
  ...
  getImages() async {
    for (int i = 0; i < widget.prod.images.length; i++) {
      _productImages.add(await fileFromImageUrl(widget.prod.images[i]));
      /*fileFromImageUrl(widget.prod.images[i]).then((value) {
        _productImages.add(value);
      });*/
    }
  ...
  void initState() {
    ...
    productNameController.text = widget.prod.productName;
    descController.text = widget.prod.productDescription;
    priceController.text = widget.prod.price.toString();
    stockController.text = widget.prod.stock.toString();
    category = widget.prod.productCategory;
    filters = widget.prod.productFilters;
    //_productImages.add(File(widget.prod.images[0]));
    ...
    print("Store Id ::::::::::::::::::::::::::: ${widget.prod.storeId}");
    print("Product Id ::::::::::::::::::::::::::: ${widget.prod.id}");
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              //Navigator.of(context).pushNamed('/ShowStatusMessagePartner', arguments: RouteArguments(param1: widget.prod.storeId, param2: widget.prod.id));

              /*Navigator.push(context, MaterialPageRoute(builder: (context) {
                return CreateDiscountOffer(storeId: widget.prod.storeId, prodId: widget.prod.id,);
              }));*/
              Navigator.of(context).pushNamed('/CreateDiscountOfferPartner',arguments: RouteArguments(param1: widget.prod.storeId, param2: widget.prod.id, param3: productNameController.text));
            },
            icon: Image.asset(
            ...
            padding: EdgeInsetsDirectional.only(end: 20, bottom: 10, top: 10),
          )
        ],
      ),
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsetsDirectional.only(top: 17),
                                child: Row(
                                  mainAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            border: Border.all(
                                                color:
                                                    productStockOutlineColor),
                                            borderRadius:
                                                BorderRadius.circular(6),
                                          ),
                                          child: Padding(
                                            padding: const EdgeInsetsDirectional
                                                .only(bottom: 5.0, start: 4),
                                            child: Center(
                                              child: TextFormField(
                                                onSaved: (value) {
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.only(
                                    start: 25, end: 22, top: 10),
                                child: Container(
                                  height: 110,
                                  decoration: BoxDecoration(
                                    border:
                                        Border.all(color: uploadOutlineColor),
                                    borderRadius: BorderRadius.circular(6),
                                  ),
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        width:
                                            MediaQuery.of(context).size.width *
                                                0.6,
                                        child: isImageLoading ? Center(child: CircularProgressIndicator(color: brown,),) : ListView.builder(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            if (productNameController
                                                .text.isEmpty) {
                                              setState(() {
                                                productNameOutLineColor =
                                                    Colors.red;
                                              });
                                            }
                                            if (descController.text.isEmpty) {
                                              setState(() {
                                                productDescOutlineColor =
                                                    Colors.red;
                                              });
                                            }
