...
class BestDealsViewAllScreen extends StatefulWidget {

  @override
  _BestDealsViewAllScreenState createState() => _BestDealsViewAllScreenState();
}

class _BestDealsViewAllScreenState extends State<BestDealsViewAllScreen> {
