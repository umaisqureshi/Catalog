...
class LatestSalesViewAllScreen extends StatefulWidget {
  @override
  _LatestSalesViewAllScreenState createState() => _LatestSalesViewAllScreenState();
}

class _LatestSalesViewAllScreenState extends State<LatestSalesViewAllScreen> {
